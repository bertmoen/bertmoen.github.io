...
var resizePizzas = function(size) { 
  ...
  // Bert modified. pulled rpcCount out of for logic
  var rpcCount = document.querySelectorAll(".randomPizzaContainer").length;
...
// Bert changed 100 to 50, the same number of pizzas generated on line ~532
for (var i = 2; i < 50; i++) {
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //Bert modified number of pizzas from 200 to 50
  for (var i = 0; i < 50; i++) {
